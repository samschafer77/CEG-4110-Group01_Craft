{\bfseries{by Erik M. Buck}}\hypertarget{md__r_e_a_d_m_e_autotoc_md1}{}\doxysection{Craft}\label{md__r_e_a_d_m_e_autotoc_md1}
...
\hypertarget{md__r_e_a_d_m_e_autotoc_md2}{}\doxysubsection{Features}\label{md__r_e_a_d_m_e_autotoc_md2}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md3}{}\doxysubsection{Download}\label{md__r_e_a_d_m_e_autotoc_md3}
Mac and Windows binaries are available on the website.

\href{http://www.michaelfogleman.com/craft/}{\texttt{ http\+://www.\+michaelfogleman.\+com/craft/}}

See below to run from source.\hypertarget{md__r_e_a_d_m_e_autotoc_md4}{}\doxysubsection{Install Dependencies}\label{md__r_e_a_d_m_e_autotoc_md4}
\hypertarget{md__r_e_a_d_m_e_autotoc_md5}{}\doxysubsubsection{Mac OS X}\label{md__r_e_a_d_m_e_autotoc_md5}
...
\end{DoxyVerb}
 \hypertarget{md__r_e_a_d_m_e_autotoc_md6}{}\doxysubsubsection{Linux (\+Ubuntu)}\label{md__r_e_a_d_m_e_autotoc_md6}
\begin{DoxyVerb}sudo apt-get install cmake libglew-dev xorg-dev libcurl4-openssl-dev
sudo apt-get build-dep glfw
\end{DoxyVerb}
 \hypertarget{md__r_e_a_d_m_e_autotoc_md7}{}\doxysubsubsection{Windows}\label{md__r_e_a_d_m_e_autotoc_md7}
...
mingw32-make
\end{DoxyVerb}
 \hypertarget{md__r_e_a_d_m_e_autotoc_md8}{}\doxysubsection{Compile and Run}\label{md__r_e_a_d_m_e_autotoc_md8}
...
./craft
\end{DoxyVerb}
 \hypertarget{md__r_e_a_d_m_e_autotoc_md9}{}\doxysubsection{Multiplayer}\label{md__r_e_a_d_m_e_autotoc_md9}
Register for an account!

\href{https://craft.michaelfogleman.com/}{\texttt{ https\+://craft.\+michaelfogleman.\+com/}}\hypertarget{md__r_e_a_d_m_e_autotoc_md10}{}\doxysubsubsection{Client}\label{md__r_e_a_d_m_e_autotoc_md10}
...
\end{DoxyVerb}
 \hypertarget{md__r_e_a_d_m_e_autotoc_md11}{}\doxysubsubsection{Server}\label{md__r_e_a_d_m_e_autotoc_md11}
...
\end{DoxyVerb}
 \hypertarget{md__r_e_a_d_m_e_autotoc_md12}{}\doxysubsection{Controls}\label{md__r_e_a_d_m_e_autotoc_md12}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md13}{}\doxysubsection{Chat Commands}\label{md__r_e_a_d_m_e_autotoc_md13}
...
\end{DoxyVerb}
 Teleport back to the spawn point.\hypertarget{md__r_e_a_d_m_e_autotoc_md14}{}\doxysubsection{Screenshot}\label{md__r_e_a_d_m_e_autotoc_md14}
\hypertarget{md__r_e_a_d_m_e_autotoc_md15}{}\doxysubsection{Implementation Details}\label{md__r_e_a_d_m_e_autotoc_md15}
\hypertarget{md__r_e_a_d_m_e_autotoc_md16}{}\doxysubsubsection{Terrain Generation}\label{md__r_e_a_d_m_e_autotoc_md16}
...
Transparency in glass blocks and plants (plants don’t take up the full rectangular shape of their triangle primitives) is implemented by discarding magenta-\/colored pixels in the fragment shader.\hypertarget{md__r_e_a_d_m_e_autotoc_md18}{}\doxysubsubsection{Database}\label{md__r_e_a_d_m_e_autotoc_md18}
...
The y-\/position of blocks are limited to 0 $<$= y $<$ 256. The upper limit is mainly an artificial limitation to prevent users from building unnecessarily tall structures. Users are not allowed to destroy blocks at y = 0 to avoid falling underneath the world.\hypertarget{md__r_e_a_d_m_e_autotoc_md19}{}\doxysubsubsection{Multiplayer}\label{md__r_e_a_d_m_e_autotoc_md19}
...
In multiplayer mode, players can observe one another in the main view or in a picture-\/in-\/picture view. Implementation of the PnP was surprisingly simple -\/ just change the viewport and render the scene again from the other player’s point of view.\hypertarget{md__r_e_a_d_m_e_autotoc_md20}{}\doxysubsubsection{Collision Testing}\label{md__r_e_a_d_m_e_autotoc_md20}
...
Collision testing simply adjusts the player’s position to remain a certain distance away from any adjacent blocks that are obstacles. (Clouds and plants are not marked as obstacles, so you pass right through them.)\hypertarget{md__r_e_a_d_m_e_autotoc_md21}{}\doxysubsubsection{Sky Dome}\label{md__r_e_a_d_m_e_autotoc_md21}
A textured sky dome is used for the sky. The X-\/coordinate of the texture represents time of day. The Y-\/values map from the bottom of the sky sphere to the top of the sky sphere. The player is always in the center of the sphere. The fragment shaders for the blocks also sample the sky texture to determine the appropriate fog color to blend with based on the block’s position relative to the backing sky.\hypertarget{md__r_e_a_d_m_e_autotoc_md22}{}\doxysubsubsection{Ambient Occlusion}\label{md__r_e_a_d_m_e_autotoc_md22}
Ambient occlusion is implemented as described on this page\+:

\href{http://0fps.wordpress.com/2013/07/03/ambient-occlusion-for-minecraft-like-worlds/}{\texttt{ http\+://0fps.\+wordpress.\+com/2013/07/03/ambient-\/occlusion-\/for-\/minecraft-\/like-\/worlds/}}\hypertarget{md__r_e_a_d_m_e_autotoc_md23}{}\doxysubsubsection{Dependencies}\label{md__r_e_a_d_m_e_autotoc_md23}
